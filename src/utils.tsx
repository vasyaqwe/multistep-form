...
export const getPrice = (billedYearly: boolean, num: number) =>
    billedYearly ? num * 10 : num

export const getPerShortText = (billedYearly: boolean) =>
    billedYearly ? "yr" : "mo"
export const getPerFullText = (billedYearly: boolean) =>
