    ...
    return (
        ...
        >
            ...
            <div className="flex justify-between flex-wrap items-center flex-1">
                <div>
                    <h3 className="text-primary-900 font-semibold text-sm md:text-base leading-none">
                ...
                <small className="text-primary-400 text-xs md:text-base">
                    +${getPrice(billedYearly, addOn.price)}/
