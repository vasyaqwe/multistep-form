...
export const Sidebar = () => {
    const stepTextLookup = ["Your Info", "Select Plan", "Add-ons", "Summary"]

    return (
        <aside
            className="bg-[url('./assets/bg-sidebar-desktop.svg')] bg-no-repeat bg-cover
                ...
                {[...Array(STEPS_COUNT).keys()].map((num) => (
                    ...
                    >
                        <div className="row-span-2 self-center">
                            <StepCircle num={num + 1} />
                        </div>
                        <p className="uppercase text-primary-300 text-sm ">
                            Step {num + 1}
                        </p>
                        <p className="uppercase text-white font-medium  col-start-2">
                            {stepTextLookup[num]}
                        </p>
                    </li>
                ))}
